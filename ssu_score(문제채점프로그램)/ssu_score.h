...
int score_blank(char *id, char *filename); //수정한 함수
double score_program(char *id, char *filename);
double compile_program(char *id, char *filename); //수정한 함수
int execute_program(char *id, char *filname); //수정한 함수
...
double get_score(char *qname); //내가만든함수
